...
assert(/:where\(\.btn,\.btn-shock,\.nav-email,\.menu-toggle,\.foot-icon-link\):active\s*\{[^}]*transform\s*:\s*scale\(0\.96\)/.test(css), 'css/landing.css: interactive controls should scale to 0.96 on press');
